...
(function () {
  ...
  var rooms = [
    ...
    '/pulse', '/trap', '/weeds', '/bouquet', '/roots', '/plumb', '/whirl', '/thaw', '/stoma', '/reed', '/waft', '/tip', '/fallow', '/commons', '/pith', '/berg', '/veil', '/tally', '/husk', '/ember', '/glean', '/buzz', '/stir', '/haha', '/dial', '/vortex', '/slack', '/pyrenoid', '/snare', '/brace', '/drift',
